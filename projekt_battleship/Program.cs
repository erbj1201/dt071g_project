    ...
    class Program
    {
        ...
        static void startMenuScreen()
        {
            ...
            while (true)
            {
                ...
                string menuNavigation = Console.ReadLine()!; //read input
                //Different action based on menu-choices
        ...
        static void PlayBattleshipGame()
        {
            ...
            do
            {
                ...
                Console.WriteLine("Do you want to start a new game? Press Enter, twice to start!");
                Console.WriteLine("");
        ...
        //instructions how to play and rules for game
        static void ShowHowToPlay()
        {
            Console.Clear();
            Console.ForegroundColor = ConsoleColor.Cyan; //color cyan
            Console.WriteLine("\n. . . . . . . . . . . . . . . . . . .");
            Console.WriteLine();
            ...
            Console.WriteLine(
                "2. Enter your name or leave blank and press Enter (if blank, you will be assigned the name 'Player_1')."
            );
            Console.WriteLine("3. Press Enter to start a game.");
            Console.ResetColor(); //reset color
            Console.WriteLine();
            Console.WriteLine();
            Console.ForegroundColor = ConsoleColor.Green; //color green
            Console.WriteLine("\n. . . . . . . . . . . . . . . . . . . . . ");
            Console.WriteLine();
            ...
            Console.WriteLine("\nPress Z to go back to the menu.");
            ConsoleKeyInfo key = ReadKeyCaseInsensitive();
            //if pressed key is z, return to menu
            ...
            {
                ShowHowToPlay(); // Keep showing instructions until Z is pressed
            }
            Console.ReadLine();
            Console.Clear();
        }
